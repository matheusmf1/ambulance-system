...
export default function TransformationProposalInfo( props ) {
  ...
  const fetchUserData = async ( id ) => {
    ...
    if ( serviceData ) {
      ...
      if ( toString( serviceData['id'] ) !== toString( id ) ) {
      ...
      return(
        <>
          <div className="form__input--halfWidth">
            ...
            <input className="form__input" type="number" required placeholder="Informe o nº de parcelas" min="1" defaultValue={ parseInt(data['paymentInfo']['installments'])} onChange={handleInformationChange('installments')}/>
          </div>
