        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form__content--inputs">
            ...
            <div className="form__input--halfWidth">
              ...
              <input className="form__input" type="text" placeholder="Informe o endereço" defaultValue={customerData['address']} onChange={handleInformationChange('address')} required/>
            </div>
            ...
            <div className="form__input--halfWidth">
              ...
              <input className="form__input" type="text" placeholder="Informe o bairro" defaultValue={customerData['neighborhood']} onChange={handleInformationChange('neighborhood')} required/>
            </div>

            <div className="form__input--halfWidth">
              <label className="form__input--label">Cidade*</label>
              <input className="form__input" type="text" placeholder="Informe a Cidade" defaultValue={customerData['city']} onChange={handleInformationChange('city')} required/>
            </div>
